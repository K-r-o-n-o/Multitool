...
; #    5. Git auto-deploy          (add/commit/push a folder)      #
...
Sections := ["Translator","LayoutFix","TypoFix","Rainbow","Deploy","Pin","Custom","General"]
TabNames := Map("Translator","Translator", "LayoutFix","Layout Fix", "TypoFix","Typo Fix",
                "Rainbow","Rainbow", "Deploy","Deploy", "Pin","Pin",
...
ShowSettings(*) {
    ...
    tab := g.AddTab3("x10 y10 w520 h378", [TabNames["Translator"], TabNames["LayoutFix"],
        TabNames["TypoFix"], TabNames["Rainbow"], TabNames["Deploy"], TabNames["Pin"],
